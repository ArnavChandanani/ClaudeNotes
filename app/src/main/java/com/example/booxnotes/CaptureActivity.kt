...
/**
 * Thin permission requester. Shows the system capture dialog ONCE, then hands the
 * grant to OverlayService, which keeps the projection alive and reuses it for every
 * capture (so the dialog never reappears until the overlay is stopped).
 */
